 ...
 *
 * Provider modules will be loaded here once implemented. For now all
 * provider slots return null so the application can start without crashing.
 *
 * When a provider is ready, replace the null with:
 *   import myProvider from './my-provider/index.js';
 * and add it to the PROVIDER_MODULES array.
 */
...
// ---------------------------------------------------------------------------
// Provider module slots – null until implementations are added.
// ---------------------------------------------------------------------------
