/**
 * /api/v1/completions — Legacy OpenAI-compatible Completions (stub)
 */
...
export default async function handler(req, res) {
    ...
    return sendError(res, 501, 'not_implemented', 'Legacy completions are not yet implemented in this backend phase.');
}
