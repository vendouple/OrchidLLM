/**
 * /api/v1/images/edits — OpenAI-compatible Image Edits (stub)
 */
...
export default async function handler(req, res) {
    ...
    return sendError(res, 501, 'not_implemented', 'Image edits are not yet implemented in this backend phase.');
}
