/**
 * /api/audio/transcriptions — Audio Transcription Gateway (stub)
 */
...
export default async function handler(req, res) {
    ...
    return sendError(res, 501, 'not_implemented', 'Transcription is not yet implemented in this backend phase.');
}
