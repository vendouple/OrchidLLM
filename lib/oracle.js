...
// Keep the native connect timeout short so a misconfigured Oracle doesn't
// eat the full Vercel 300 s limit. The connection string may embed its own
// retry_count/retry_delay, but this caps each individual attempt.
const CONNECT_TIMEOUT_SECONDS = Number(process.env.ORACLE_DB_CONNECT_TIMEOUT_SECONDS || 5);
