    ...
    try {
        const result = await executeQuery(`
            SELECT
                ...
                td.display_name AS canonical_tier_name,
                td.tier_key AS canonical_tier_code,
...
export async function deductCredits({ userId, promptTokens, completionTokens, modelRow, isBatch, isCached }) {
