# Zanity AI API Documentation

> **Base URL:** `https://api.zanity.xyz/v1`
> **Authentication:** `Authorization: Bearer <your_api_key>`
> **Supported Modalities:** Text, Image

Zanity AI acts as a standard OpenAI-compatible API gateway/provider.
...
### Example Request
```bash
curl https://api.zanity.xyz/v1/chat/completions \
