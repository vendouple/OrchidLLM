# StudioLM API Documentation

> **Base URL:** `https://api.studiolm.dev/v1`
> **Authentication:** `Authorization: Bearer <your_api_key>`
> **Supported Modalities:** Text, Image, TTS

StudioLM acts as a standard OpenAI-compatible API gateway/provider.
