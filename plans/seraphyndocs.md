# Seraphyn AI API Documentation

> **Base URL:** `https://seraphyn.ai/api/v1`
> **Authentication:** `Authorization: Bearer <your_api_key>`
> **Supported Modalities:** Text, Image

Seraphyn AI acts as a standard OpenAI-compatible API gateway/provider.
...
### Example Request
```bash
curl https://seraphyn.ai/api/v1/chat/completions \
