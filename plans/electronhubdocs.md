# ElectronHubAI API Documentation

> **Base URL:** `https://api.electronhub.ai/v1`
> **Authentication:** `Authorization: Bearer <your_api_key>`
> **Supported Modalities:** Text, Image, TTS, Transcription

ElectronHubAI acts as a standard OpenAI-compatible API gateway/provider.
