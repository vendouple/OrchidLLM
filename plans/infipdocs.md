# Infip API Documentation

> **Base URL:** `https://api.infip.pro/v1`
> **Authentication:** `Authorization: Bearer <your_api_key>`
> **Supported Modalities:** Text, Image

Infip acts as a standard OpenAI-compatible API gateway/provider.
...
### Example Request
```bash
curl https://api.infip.pro/v1/chat/completions \
