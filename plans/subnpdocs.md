# SubNP API Documentation

> **Base URL:** `https://api.subnp.com/v1`
> **Authentication:** `Authorization: Bearer <your_api_key>`
> **Supported Modalities:** Text, Image

SubNP acts as a standard OpenAI-compatible API gateway/provider.
...
### Example Request
```bash
curl https://api.subnp.com/v1/chat/completions \
