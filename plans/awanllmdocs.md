# AwanLLM API Documentation

> **Base URL:** `https://api.awanllm.com/v1`
> **Authentication:** `Authorization: Bearer <your_api_key>`
> **Supported Modalities:** Text

AwanLLM acts as a standard OpenAI-compatible API gateway/provider.
...
### Example Request
```bash
curl https://api.awanllm.com/v1/chat/completions \
